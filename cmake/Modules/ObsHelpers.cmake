...
if(NOT UNIX_STRUCTURE)
	...
	if(APPLE)
		...
		set(OBS_PLUGIN32_DESTINATION "plugins")
		set(OBS_PLUGIN64_DESTINATION "plugins")
		...
		set(OBS_PLUGIN_DESTINATION "plugins/${_lib_suffix}bit")
	...
	set(OBS_PLUGIN_DESTINATION "${OBS_LIBRARY_DESTINATION}/plugins")
	set(OBS_PLUGIN32_DESTINATION "${OBS_LIBRARY32_DESTINATION}/plugins")
	set(OBS_PLUGIN64_DESTINATION "${OBS_LIBRARY64_DESTINATION}/plugins")
...
function(export_obs_core target exportname)
	...
	set(CONF_PLUGIN_DEST "${CMAKE_BINARY_DIR}/rundir/${CMAKE_BUILD_TYPE}/plugins/${_lib_suffix}bit")
	set(CONF_PLUGIN_DEST32 "${CMAKE_BINARY_DIR}/rundir/${CMAKE_BUILD_TYPE}/plugins/32bit")
	set(CONF_PLUGIN_DEST64 "${CMAKE_BINARY_DIR}/rundir/${CMAKE_BUILD_TYPE}/plugins/64bit")
	set(CONF_PLUGIN_DATA_DEST "${CMAKE_BINARY_DIR}/rundir/${CMAKE_BUILD_TYPE}/data/plugins")
	...
	set(CONF_PLUGIN_DATA_DEST "\${CMAKE_CURRENT_LIST_DIR}/${_pdir}${OBS_DATA_DESTINATION}/plugins")
...
function(install_obs_pdb ttype target)
	...
	if("${ttype}" STREQUAL "PLUGIN")
		obs_debug_copy_helper(${target} "${OBS_OUTPUT_DIR}/$<CONFIGURATION>/plugins/${_bit_suffix}")
...
function(install_obs_plugin target)
	...
	add_custom_command(TARGET ${target} POST_BUILD
		COMMAND "${CMAKE_COMMAND}" -E copy
			"$<TARGET_FILE:${target}>"
			"${OBS_OUTPUT_DIR}/$<CONFIGURATION>/plugins/${_bit_suffix}$<TARGET_FILE_NAME:${target}>"
		VERBATIM)
...
function(install_obs_plugin_with_data target datadir)
	...
	install_obs_data(${target} "${datadir}" "plugins/${target}")
endfunction()
