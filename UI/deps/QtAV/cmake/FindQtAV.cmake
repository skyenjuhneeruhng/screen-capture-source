...
find_path(QTAV_INCLUDE_DIR NAMES QtAV.h
    HINTS ${QT_INSTALL_HEADERS} "${CMAKE_SOURCE_DIR}/UI/deps/QtAV/src"
    PATH_SUFFIXES QtAV
)
find_library(QTAV_LIBRARY NAMES QtAV QtAV1
    HINTS ${QT_INSTALL_LIBS} "${CMAKE_BINARY_DIR}/lib"
)

find_path(QTAVWIDGETS_INCLUDE_DIR NAMES QtAVWidgets.h
    HINTS ${QT_INSTALL_HEADERS} "${CMAKE_SOURCE_DIR}/UI/deps/QtAV/widgets"
