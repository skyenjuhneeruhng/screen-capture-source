...
static void OBSStartRecording(void *data, calldata_t *params)
{
	...
	QMetaObject::invokeMethod(output->main, "recordButtonRecording");
...
static void OBSStopRecording(void *data, calldata_t *params)
{
	...
	QMetaObject::invokeMethod(output->main, "recordButtonStopped", Q_ARG(int, code));
...
{
	BasicOutputHandler *output = static_cast<BasicOutputHandler*>(data);
	QMetaObject::invokeMethod(output->main, "recordButtonStopping");
