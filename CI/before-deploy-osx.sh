...
mv ./rundir/RelWithDebInfo/plugins/CEF.app ./
mv ./rundir/RelWithDebInfo/plugins/obs-browser.so ./
...
hr "Moving CEF back"
mv ./CEF.app ./rundir/RelWithDebInfo/plugins/
mv ./obs-browser.so ./rundir/RelWithDebInfo/plugins/
